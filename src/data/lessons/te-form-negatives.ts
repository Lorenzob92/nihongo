  ...
  steps: [
    ...
    },
    {
      ...
      conjugationTable: [
        ...
        ["Irregular", "する → して ／ 来(く)る → 来(き)て", "suru → shite / kuru → kite"],
      ],
    },
    {
      type: "cheatsheet",
      ...
      conjugationTable: [
        ...
        ["行く (odd one) → って", "行(い)く → 行って ／ 行った", "iku → itte / itta"],
        ["する", "勉強(べんきょう)する → 勉強して", "benkyō suru → benkyō shite"],
        ["来る", "来(く)る → 来(き)て ／ 来た", "kuru → kite / kita"],
      ],
    },
    {
      type: "cheatsheet",
      ...
      conjugationTable: [
        ["English", "Polite ／ casual", "Romaji"],
        ["won't do", "ません ／ ない", "-masen / -nai"],
        ["didn't do", "ませんでした ／ なかった", "-masen deshita / -nakatta"],
        ["haven't done (experience)", "たことがありません ／ たことがない", "-ta koto ga arimasen / nai"],
        ["haven't done (not yet)", "(まだ) ていません ／ てない", "(mada) -te imasen / -tenai"],
        ["hadn't done (experience)", "たことがありませんでした ／ たことがなかった", "-ta koto ga arimasen deshita / nakatta"],
        ["hadn't done (not yet)", "(まだ) ていませんでした ／ てなかった", "(mada) -te imasen deshita / -tenakatta"],
        ["have done (experience)", "たことがあります ／ たことがある", "-ta koto ga arimasu / aru"],
        ["Trap", "もう〜ましたか → まだ〜ていません", "never 〜ませんでした for \"not yet\""],
      ],
    },
    {
      type: "wrap",
